...
All notable changes to the "an-sw-ts" extension will be documented in this file.
...
- 打开接口详情不重复创建新 tab [#15](https://github.com/bianliuzhu/an-sw-ts/issues/15)
- 修复未分组接口不显示问题
- 修复无效分组接口不现实问题
...
- 修复错误 url 阻塞进程的问题 [#16](https://github.com/bianliuzhu/an-sw-ts/issues/16)
